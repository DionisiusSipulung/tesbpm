...
// 2. TEMPLATE HTML (Konten Utama Website)
const appTemplate = `
    <!-- LAYER COMING SOON -->
...
                <div class="text-center"><div id="days" class="text-4xl md:text-6xl font-black text-white italic tracking-tighter">00</div><div class="text-[10px] text-gray-500 font-bold uppercase mt-2">Hari</div></div>
                <div class="text-4xl text-blue-600 font-black mb-6">:</div>
                <div class="text-center"><div id="hours" class="text-4xl md:text-6xl font-black text-white italic tracking-tighter">00</div><div class="text-[10px] text-gray-500 font-bold uppercase mt-2">Jam</div></div>
                <div class="text-4xl text-blue-600 font-black mb-6">:</div>
                <div class="text-center"><div id="minutes" class="text-4xl md:text-6xl font-black text-white italic tracking-tighter">00</div><div class="text-[10px] text-gray-500 font-bold uppercase mt-2">Menit</div></div>
                <div class="text-4xl text-blue-600 font-black mb-6">:</div>
                <div class="text-center"><div id="seconds" class="text-4xl md:text-6xl font-black text-white italic tracking-tighter">00</div><div class="text-[10px] text-gray-500 font-bold uppercase mt-2">Detik</div></div>
            </div>
...
                    <p class="italic text-gray-600 mb-6 text-lg">"Terwujudnya SEMA FT yang aktif, harmonis, dan profesional sebagai wadah aspirasi mahasiswa Teknik."</p>
                </div>
...
                    <p class="italic text-gray-600 mb-6 text-lg">"Menciptakan iklim organisasi legislatif yang transparan, kritis, dan komunikatif."</p>
                </div>
            </div>
        </section>
...
        <div class="bg-gradient-to-br from-blue-700 to-indigo-900 rounded-[2.5rem] p-10 text-white mb-10 shadow-2xl">
            <h1 class="text-4xl font-black mb-4 italic tracking-tighter">Dashboard Portal Mahasiswa</h1>
        </div>
        <div class="grid md:grid-cols-2 gap-8 mb-12">
            <div class="bg-white p-10 rounded-[2rem] border border-gray-200 shadow-sm">
                <h3 class="font-black text-2xl mb-4 italic uppercase tracking-tighter text-red-600">Kotak Aspirasi</h3>
                <button onclick="toggleAspirasiModal()" class="w-full bg-red-50 text-red-600 py-4 rounded-2xl font-black uppercase tracking-widest">Kirim Suara Mahasiswa →</button>
            </div>
        </div>
        <section id="adminPanel" class="hidden animate-fade">
             <div class="bg-gray-800 p-8 text-white rounded-t-[2.5rem] flex justify-between items-center">
                <h2 class="text-xl font-black uppercase italic text-blue-400">Daftar Aspirasi Masuk</h2>
                <span class="bg-blue-600 text-[10px] font-bold px-4 py-1 rounded-full animate-pulse">Admin Mode</span>
            </div>
            <table class="w-full text-left bg-white rounded-b-[2.5rem]">
...
        <div class="bg-white rounded-[2.5rem] p-10 max-w-md w-full relative">
            <button onclick="toggleAuthModal()" class="absolute top-6 right-6 text-3xl font-light">&times;</button>
            <div id="loginForm">
...
        <div class="bg-white rounded-[2.5rem] p-10 max-w-2xl w-full relative">
            <button onclick="toggleAspirasiModal()" class="absolute top-6 right-8 text-4xl font-light">&times;</button>
...
        snap.forEach(doc => {
            const d = doc.data();
            list.innerHTML += `<tr class="border-b"><td class="p-6 text-gray-700">${d.pesan}</td></tr>`;
        });
    });
}
